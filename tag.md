## Get a group of tags by querying
...
| ---------- | ---------------- | --------------------------- | ---------------------------------------- |
| loopid     | MongoDB ObjectId | 592a63088e46ce684784a6b3    | loopid of tags                           |
| type       | String           | general /  character / safe | type of tags                             |
...
```bash
# Get a group of tags which loopid is 59adf78ac4c0bc657943222d and type is character
